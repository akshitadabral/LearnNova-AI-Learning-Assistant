...
const getQuizzesForDocument = async (documentId) => {
    try {
        ...
        handleError(error,'Failed to fetch quizzes');
    }
};
...
const getQuizById = async (quizId) => {
    try {
        ...
        handleError(error,'Failed to fetch quiz');
    }
};
...
const submitQuiz = async (quizId,answers) => {
    try {
        ...
        handleError(error,'Failed to submit quiz');
    }
};
...
const getQuizResults = async (quizId) => {
    try {
        ...
        handleError(error,'Failed to fetch quiz results');
    }
};
