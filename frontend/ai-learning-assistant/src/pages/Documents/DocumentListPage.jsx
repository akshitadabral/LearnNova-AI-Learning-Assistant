...
const DocumentListPage = () => {
  ...
  // State for delete confirmation nodal
      ...
      return (
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-r from-slate-100 to-slate-200 shadow-lg shadow-slate-200/50 mb-6">
              <FileText
            ...
            <p className="text-sm text-slate-500 mb-6">
              Upload your notes, books, or study material.
              Learnova will help you create summaries, flashcards, and quizzes.
            </p>
            <button
              onClick={() => setIsUploadModalOpen(true)}
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:shadow-emerald-500/30 active:scale-[0.981]"
            >
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-slate-500 text-sm">
              Upload your study material and let LearnNova create AI-powered learning resources.
            </p>
          </div>
          {documents.length > 0 && (
          ...
          <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-500 mt-1">
                Upload a PDF and let Learnova generate AI learning resources.
              </p>
            </div>
          ...
          <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={deleting}
                className="flex-1 h-11 px-4 bg-gradient-to-r from-red-500 to-red-600 hover:to-red-700 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-red-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
              >
                {deleting ? (
                  <span className="flex items-center justify-center gap-2">
