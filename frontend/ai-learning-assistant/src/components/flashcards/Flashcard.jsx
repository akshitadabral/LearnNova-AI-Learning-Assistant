...
const Flashcard = ({ flashcard, onToggleStar }) => {
    ...
    return <div className="relative w-full h-72" style={{ perspective: '1000px' }}>
        <div
            className={`relative w-full h-full transition-transform duration-500 transform-gpu cursor-pointer hover:scale-[1.01]`}
            style={{
        ...
        >
            ...
            >
                ...
                <div className="flex items-start justify-between">
                    <div
                        className={`text-[10px] px-4 py-1 rounded uppercase font-semibold ${difficultyColors[flashcard?.difficulty] ||
