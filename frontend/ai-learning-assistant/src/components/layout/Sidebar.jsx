...
const Sidebar=({isSidebarOpen,toggleSidebar})=>{
 ...
 return(
  <>
   ...
   <aside
    className={`fixed top-0 left-0 h-full w-72 z-50 bg-white/80 backdrop-blur-xl border-r border-slate-200/70 shadow-xl md:relative md:flex md:flex-col md:translate-x-0 transition-transform duration-300 ${
    ...
    <div className="h-20 px-6 flex items-center justify-between border-b border-slate-200/70">
     ...
     <Link to="/dashboard" className="flex items-center gap-3">
      <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-blue-500/30">
       <BrainCircuit className="text-white" size={23} strokeWidth={2.5}/>
      </div>
