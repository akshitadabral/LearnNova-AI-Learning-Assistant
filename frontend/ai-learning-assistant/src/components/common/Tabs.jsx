        ...
        <nav className="flex gap-2 overflow-x-auto whitespace-nowrap scrollbar-hide">
          {tabs.map((tab) => (
            <button
              ...
              className={`relative py-3 px-4 md:px-6 text-sm font-semibold transition-all duration-200 ${
                activeTab === tab.name
                  ?  "text-emerald-600 bg-emerald-50 rounded-t-xl"
                  :  "text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-t-xl"
              }`}
            >
